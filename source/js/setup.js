...
MemoryMatch.GameSetup = {
    ...
    levels: [{gameId: 4, gameCount: 6, challengeGameId: 3, challengeAdvanceStreak: 4, icon: "iconHudLand1", title: "Wife Pairing", subtitle: "Classic memory match game", mapImage: "land1", mapPosition: {x: 300, y: 738}, primaryColor: "#3bc7e4", secondaryColor: "#2393a7", liteColor: "#58ddf5"},
             {gameId: 5, gameCount: 6, challengeGameId: 6, challengeAdvanceStreak: 4, icon: "iconHudLand2", title: "A Housewife Never Forgets",    subtitle: "A twist on memory", mapImage: "land2", mapPosition: {x: 880, y: 1160}, primaryColor: "#f27015", secondaryColor: "#ce5f12", liteColor: "#ff9b55"},
             {gameId: 7, gameCount: 6, challengeGameId: 1, challengeAdvanceStreak: 4, icon: "iconHudLand2", title: "A Race Against Wine",  subtitle: "Make matches to stop your nemesis from progressing", mapImage: "land3", mapPosition: {x: 1580, y: 404}, primaryColor: "#8e5fa5", secondaryColor: "#6b437f", liteColor: "#be81dc"},
             {gameId: 2, gameCount: 6, challengeGameId: 8, challengeAdvanceStreak: 4, icon: "iconHudLand4", title: "Housewives in a Haystack",     subtitle: "Remember the cards", mapImage: "land4", mapPosition: {x: 1480, y: 1060}, primaryColor: "#d2428d", secondaryColor: "#a93370", liteColor: "#f850a7"}],
    games: [
